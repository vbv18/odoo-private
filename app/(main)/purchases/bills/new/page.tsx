  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setErrors({ general: data.message || 'Failed to create vendor bill' });
      }
    } catch {
  ...
  return (
    <div className="max-w-[1000px] mx-auto px-4 sm:px-6 lg:px-8 py-6">
      <div className="mb-6">
        ...
        <h1 className="text-[24px] font-semibold text-[#111827]">New Vendor Bill</h1>
        <p className="text-[14px] text-[#667085] mt-1">Record a payable bill directly into the accounting system</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-white border border-[#E5E7EB] rounded-enterprise p-6 shadow-xs">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-[16px] font-semibold text-[#111827]">Billed Line Items</h2>
