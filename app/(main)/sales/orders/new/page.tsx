  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setErrors({ general: data.message || 'Failed to create sales order' });
      }
    } catch {
  ...
  return (
    <div className="max-w-[1000px] mx-auto px-4 sm:px-6 lg:px-8 py-6">
      <div className="mb-6">
        ...
        <h1 className="text-[24px] font-semibold text-[#111827]">New Sales Order</h1>
        <p className="text-[14px] text-[#667085] mt-1">Book an order agreement with a customer</p>
      </div>
