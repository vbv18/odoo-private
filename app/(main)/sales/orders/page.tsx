  ...
  return (
    <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        <div>
          <h1 className="text-[24px] font-semibold text-[#111827]">Sales Orders</h1>
          <p className="text-[14px] text-[#667085] mt-1">Manage customer purchase commitments, fulfillments, and invoicing</p>
        </div>
      ...
      <div className="bg-white border border-[#E5E7EB] rounded-enterprise overflow-hidden shadow-xs">
        {isLoading ? (
          ...
          <div className="p-12 text-center">
            <p className="text-[15px] font-medium text-[#111827]">No sales orders found</p>
            <p className="text-[13px] text-[#667085] mt-1">Create a sales order to record commitments from customers</p>
            <Button
              onClick={() => router.push('/sales/orders/new')}
              className="mt-4"
            >
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-[#E5E7EB] bg-[#F7F8FA]">
                <th className="text-left py-3 px-4 text-[11px] font-semibold text-[#667085] uppercase tracking-wide">SO Number</th>
                ...
                <th className="text-left py-3 px-4 text-[11px] font-semibold text-[#667085] uppercase tracking-wide">Delivery Date</th>
