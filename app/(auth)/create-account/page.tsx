...
export default function CreateAccountPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      {successMessage && (
        <div className="p-3 bg-emerald-50 border border-emerald-200 rounded-enterprise text-sm text-primary-green">
          {successMessage}
        </div>
      )}
            ...
            <div className="flex flex-wrap gap-4 sm:gap-6">
              <label className="flex items-center cursor-pointer">
                <input
                  ...
                  className="h-4 w-4 text-ai-blue focus:ring-ai-blue"
                />
