    ...
    <div className="bg-white border border-[#E5E7EB] rounded-xl p-5 shadow-2xs">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-4 border-b border-[#F0F2F5]">
        <div className="flex items-center gap-3">
          ...
          <div className="relative">
            <button
              ...
              className="inline-flex items-center gap-1.5 px-2.5 py-1 text-[12px] font-medium text-[#111827] bg-[#F7F8FA] border border-[#E5E7EB] rounded-md hover:bg-gray-100 transition-colors"
            >
            ...
            {periodDropdownOpen && (
              <div className="absolute left-0 mt-1 w-44 bg-white rounded-lg shadow-lg border border-[#E5E7EB] py-1 z-30">
                {periods.map((p) => (
                  <button
                    key={p}
                    type="button"
                    ...
                    className={`w-full text-left px-3 py-1.5 text-[12px] hover:bg-[#F7F8FA] ${
                      selectedPeriod === p ? 'text-[#16A34A] font-medium bg-[#F7F8FA]' : 'text-[#111827]'
                    }`}
                  >
                    {p}
                  </button>
        ...
        <Link
          ...
          className="text-[12px] font-medium text-[#2563EB] hover:underline inline-flex items-center gap-1 group self-start sm:self-auto"
        >
      ...
      {/* Top Split Section: Stat blocks (Left) + Donut/Stacked Progress (Right) */}
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6 py-5 items-center">
        {/* Left 3 compact stat blocks (md:col-span-7 or 8) */}
        <div className="md:col-span-8 grid grid-cols-1 sm:grid-cols-3 gap-3">
          {/* Achieved */}
          <div className="p-3.5 rounded-lg bg-[#F7F8FA] border border-[#E5E7EB]/80">
            ...
            <div className="mt-1.5 text-[18px] font-semibold text-[#111827] tabular-nums">
        ...
        {/* Right side: Clean Donut Chart (md:col-span-4 or 5) */}
        <div className="md:col-span-4 flex items-center justify-center md:justify-end gap-5 pl-0 md:pl-4 border-t md:border-t-0 md:border-l border-[#F0F2F5] pt-4 md:pt-0">
          <div className="relative flex items-center justify-center">
            ...
            >
              ...
              <circle
                ...
                fill="transparent"
              />
              {/* Achieved Primary Green segment */}
              <circle
                cx={size / 2}
                cy={size / 2}
                r={radius}
          ...
          <div className="space-y-2 text-[11px]">
            <div className="flex items-center gap-2">
              <span className="w-2.5 h-2.5 rounded-xs bg-[#16A34A] shrink-0" />
              <div>
      ...
      {/* Below: Compact Table (max 5 rows) of top budgets by utilization */}
      <div className="mt-4 pt-4 border-t border-[#F0F2F5]">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse" aria-label="Top Budgets by Utilization">
            <thead>
              <tr className="border-b border-[#E5E7EB] text-[11px] uppercase tracking-wider font-semibold text-[#667085] bg-[#F7F8FA]">
                <th scope="col" className="py-2 px-3 font-semibold">Budget Name</th>
                <th scope="col" className="py-2 px-3 font-semibold">Period</th>
                <th scope="col" className="py-2 px-3 text-right font-semibold">Committed</th>
                <th scope="col" className="py-2 px-3 text-right font-semibold">Achieved</th>
                <th scope="col" className="py-2 px-3 font-semibold w-40">% Used</th>
                <th scope="col" className="py-2 px-3 text-right font-semibold">Status</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-[#E5E7EB] text-[13px]">
              {BUDGET_RECORDS.map((item) => {
                // Color for progress bar and status badge
                ...
                return (
                  ...
                  >
                    ...
                    <td className="py-2.5 px-3 text-right">
                      <span
                        className={`inline-block text-[11px] font-medium px-2 py-0.5 rounded-full border ${badgeClass}`}
                      >
                        {item.status}
                      </span>
                    </td>
